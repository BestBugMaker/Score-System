...
<body style="background:url(img/背景图片.jpg); background-attachment: fixed; background-repeat: no-repeat; background-size: cover;font-family: Arial">
    ...
    <table width="100%" height="500px" border="1">
        <tbody>
        <tr align="center">
            <td width="20%"><iframe style="background-color: rgba(247,245,246,0.70)" name="menu" width="100%" height="100%" src="学生/学生功能选择界面.jsp" align="middle"></iframe></td>
